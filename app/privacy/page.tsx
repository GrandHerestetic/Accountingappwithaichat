          ...
          <div className="space-y-8">
            ...
            <Card>
              ...
              <CardContent className="prose prose-gray max-w-none">
                ...
                <ul>
                  ...
                  <li>Реквизиты организации (при необходимости для верификации)</li>
                </ul>
            ...
            <Card>
              ...
              <CardContent className="prose prose-gray max-w-none">
                ...
                <ul>
                  ...
                  <li>Модерации и поддержки пользователей</li>
            ...
            <Card>
              ...
              <CardContent className="prose prose-gray max-w-none">
                ...
                <ul>
                  <li>Поставщикам инфраструктуры (хостинг, почта) — только в объёме, нужном для работы сервиса</li>
