  ...
  const faq = [
    {
      ...
      answer:
        "Да, вы можете изменить тарифный план в любое время в настройках аккаунта. При переходе на более дорогой план доплата рассчитывается пропорционально.",
    },
    {
      question: "Есть ли скидки для долгосрочных подписок?",
      answer: "Да, при оплате на год вы получаете скидку 20%. При оплате на полгода - скидку 10%.",
    },
    {
