          ...
          <div className="space-y-8">
            ...
            <Card>
              ...
              <CardContent className="prose prose-gray max-w-none">
                ...
                <ul>
                  <li>Базовая стоимость размещения: 2000-3000 ₸</li>
                  <li>Дополнительные опции оплачиваются отдельно</li>
                  <li>Оплата производится до публикации заказа</li>
                </ul>

                <h4>Оплата откликов:</h4>
                <ul>
                  <li>Стоимость отклика: 500-1000 ₸</li>
                  <li>Оплата не возвращается при невыборе</li>
                  <li>Доступ к контактам предоставляется после оплаты</li>
                </ul>

                <h4>Возвраты:</h4>
                <ul>
                  <li>Возврат за размещение заказа возможен в течение 24 часов</li>
                  <li>Возврат за отклики не предусмотрен</li>
                  <li>Спорные ситуации рассматриваются администрацией</li>
                </ul>
              </CardContent>
            </Card>
